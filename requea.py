...
def parse_gateway_row(raw, site_name):
    ...
    # Première colonne parasite Requea
    if parts[0] == "a":
        parts = parts[1:]
    ...
    # Seulement les passerelles Active
    if status != "Active":
        return None
        ...
        try:
            ...
            for i in range(count):
                ...
                if history[key]["down_since"]:
                    ...
                    down_hours = round(
                        (NOW - down_start).total_seconds() / 3600,
                        1
                    )
...
print(
    f"Dashboard généré avec {total} passerelles Active"
)
